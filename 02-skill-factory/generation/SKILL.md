...
**載入**：同 mode=dual-track + `shared-references/blood-bag-evaluation.md` + **藏鏡人人格大腦**（若 Q 字卡角色為「安」、強制載入 `01-data-brain/personas/an.md` + `01-data-brain/persona-an-questionnaire-v2.md`、Q 字卡必對齊：[2] 互稱「楷哥」+ [9] 口頭禪庫（蛤 / 認真 / 靠杯 / 真的喔）+ [13] 反應觸發點 + [14] Driver/Reaction 雙模式 70/30 比例。對應 L-0043 lesson）
