...
> 雙方契約：Claude Code (consumer) + Codex (writer + CLI)
...
5. 原 md 檔 rename 為 `*.legacy.md`、migration 驗證後由 Claude/Codex 清除（v4.73 清除、內容已全數進 todos.json）
